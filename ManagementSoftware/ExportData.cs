                    ...
                    if (sfd.ShowDialog() == DialogResult.OK)
                    {
                        try
                        {
                            await Task.Run(() =>
                            {
                                ...
                                //Paragraph paragraphNguoiVanHanh = new Paragraph("Người vận hành : " + result.Username);
                                //paragraphNguoiVanHanh.SetFontSize(14);
                                //Paragraph paragraphLoaiKhi = new Paragraph("Loại khí : " + result.LoaiKhi);
                                //paragraphLoaiKhi.SetFontSize(14);
                                //Paragraph paragraphSoLuongGian1 = new Paragraph("Số lượng bình nạp giàn 1 : " + (result.SoLuongBinhCanNapHe1 ?? 0).ToString());
                                //paragraphSoLuongGian1.SetFontSize(14);
                                //Paragraph paragraphSoLuongGian2 = new Paragraph("Số lượng bình nạp giàn 2 : " + (result.SoLuongBinhCanNapHe2 ?? 0).ToString());
                                //paragraphSoLuongGian2.SetFontSize(14);
                                //Paragraph paragraphTheTichCanNap = new Paragraph("Thể tích cần nạp : " + (result.TheTichCanNap ?? 0).ToString() + "L");
                                //paragraphTheTichCanNap.SetFontSize(14);
                                //Paragraph paragraphApSuatTieuChuan = new Paragraph("Áp suất tiêu chuẩn : " + (result.ApSuatTieuChuan ?? 0) + "Bar");
                                //paragraphApSuatTieuChuan.SetFontSize(14);
                                //Paragraph paragraphTheTichTieuChuan = new Paragraph("Thể tích tiêu chuẩn : " + (result.TheTichTieuChuan ?? 0).ToString() + " L");
                                //paragraphTheTichTieuChuan.SetFontSize(14);
                                //Paragraph paragraphHeSoTieuChuan = new Paragraph("Hệ số tiêu chuẩn : " + (result.HeSoTieuChuan ?? 0).ToString());
                                //paragraphHeSoTieuChuan.SetFontSize(14);
                                //Paragraph paragraphThoiGianTrichMau = new Paragraph("Thời gian trích mẫu : " + result.ThoiGianTrichMau?.ToString("HH:mm:ss") ?? "00:00:00");
                                //paragraphThoiGianTrichMau.SetFontSize(14);
                                //Paragraph paragraphThoiGianBatDau = new Paragraph("Thời gian bắt đầu : " + result.TimeStart.ToString("HH:mm:ss dd/MM/yyyy"));
                                //paragraphThoiGianBatDau.SetFontSize(14);
                                //Paragraph paragraphThoiGianKetThuc = new Paragraph(result.TimeStart < result.TimeEnd ? "Thời gian kết thúc : " + result.TimeEnd.ToString("HH:mm:ss dd/MM/yyyy") : "Thời gian kết thúc : ");
                                //paragraphThoiGianKetThuc.SetFontSize(14);
                                //Paragraph paragraphTrangThai = new Paragraph(result.Status == true ? "Trạng thái : OK" : "Trạng thái : NG");
                                //paragraphTrangThai.SetFontSize(14);

                                float pageSize = pdfDoc.GetPage(1).GetPageSize().GetWidth();
