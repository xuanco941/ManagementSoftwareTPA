...
namespace ManagementSoftware.GUI.Dashboard_Management
{
    public partial class HeNap : Form
    {
        ...
        {
            InitializeComponent();
            heNap1 = new TheoDoiHeNap(AddressPLC.DATA_PC_PC_RunSYS, AddressPLC.DATA_PC_PC_ong_H1, AddressPLC.DATA_PC_ST_Run_Nap_H1,
            ...
            heNap2 = new TheoDoiHeNap(AddressPLC.DATA_PC_PC_RunSYS, AddressPLC.DATA_PC_PC_ong_H2, AddressPLC.DATA_PC_ST_Run_Nap_H2,
