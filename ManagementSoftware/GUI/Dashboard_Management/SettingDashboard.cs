...
namespace ManagementSoftware.GUI
{
    public partial class SettingDashboard : Form
    {
        ...
        public async Task LoadData()
        {
            ...
            heSoTieuChuan = await Task.Run(() => plc.ReadAVariableNumber<float>(AddressPLC.DATA_SETUP_DATA_SetupHS_Nhiet_do));
            thoiGianTrichMau = await Task.Run(() => plc.ReadAVariableNumber_ReadAny<TimeSpan>(AddressPLC.DATA_SETUP_Time_trich_mau));
            ...
            labelThoiGianTrichMau.Text = thoiGianTrichMau != null ? thoiGianTrichMau?.TotalSeconds.ToString() : Common.ERR;
